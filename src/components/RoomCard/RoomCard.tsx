...
const RoomCard: FC<Props> = (props) => {
  const {
    room: { coverImage, name, price, type, desciption, slug, isBooked },
  } = props;
  return (
    <div className="rounded-xl w-72 mb-10 mx-auto md:mx-1 overflow-hidden text-black">
      ...
      <div className="p-4 bg-white">
        ...
        <p className="pt-3 pb-6">{desciption.slice(0, 70)}...</p>
        <Link
