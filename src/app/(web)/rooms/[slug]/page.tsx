              ...
              <div className="flex my-11">
                {room.offeredAmenities &&
                  room.offeredAmenities.map((ammenity) => (
                    <div
                      key={ammenity._key}
                      className="md:w-64 w-fit text-center px-2 md:px-0 h-20 md:h-40 mr-3 bg-[#eff0f2] darl:bg-gray-800 rounded-lg place-content-center"
                    >
                      <i
                        className={`fa-solid ${ammenity.icon} md:text-2xl`}
                      ></i>
                      <p className="text-xs md:text-base pt-3"></p>
                    </div>
                  ))}
              </div>
              <div className="mb-11">
